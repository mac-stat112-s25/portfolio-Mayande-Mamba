...
- The Sat scores range from around 100 to 1100, the most typical outcomes is around 900 and another smaller peak at around 1300- Student either get high scores ar low scores  
...
-They both have a negative weak relationship with sat scores. The higher the salary and expenditure, the lower the sat scores this is quite weird 
...
- Lower expenditure, lower salary equal higher sat and higher salary and higher expenditure has lower sat scores 
...
- There is an addition of controll b only including the rpecentage of people that only take the Sat score, hence the rel;ationship is now positive 
