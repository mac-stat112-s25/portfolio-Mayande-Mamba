...
#Can only zoom intil names stop showing 
leaflet(data = fave_places) |> 
  addTiles() |> 
  addMarkers()
```
...
```{r}
#It is hard to identify a pattern 
...
```{r}
#contour map of the large country 
# What changed in the plot?
# What changed in our code?!
ggplot(cma_boundaries) + 
  geom_sf() + 
  geom_density_2d( # This is not geom point 
    data = starbucks_cma,
    aes(x = Longitude, y = Latitude),
    size = 0.2,
    color = "darkgreen"
...
ggplot(elections_by_counties, aes(map_id = county_fips, fill = median_rent)) +
  ...
  theme(legend.position = "right") + 
  coord_equal()+
  scale_fill_gradientn(name="median_rent", colors= c("white","lightgreen","darkgreen"))
```
...
ggplot(elections_by_counties, aes(map_id = county_fips, fill = median_age)) +
  ...
  theme(legend.position = "right") + 
  coord_equal()+
  scale_fill_gradientn(name="median_age", colors=terrain.colors(10))
```
