...
# How does this differ than the frame for our histogram of repub_pct_20 alone? - This has x and y for the aes function)
ggplot(elections, aes(y = repub_pct_20, x = repub_pct_16))
```
...
# What happens if you change the shape to another number?- The shape of the point changes
ggplot(elections, aes(y = repub_pct_20, x = repub_pct_16)) +
  geom_point(shape = 2)
```
...
```{r}
# Scatterplot of repub_pct_20 vs median_rent - There seems to a weak negetive relationship between support in 2020 and median rent - This is a better predictor
ggplot(elections, aes(y=repub_pct_20,x=median_rent))+
  geom_point()


# Scatterplot of repub_pct_20 vs median_age- There seems to be no relationship between the two 
