...
- subjects who received only 3 hours of sleep per night
...
`ggplot(sleep_wide, aes(y = reaction_time, x = number_days, color = person/subject))`
...
# For cols, try 2 appproaches: using - and starts_with
 sleep_wide |> 
   pivot_longer(cols = -Subject, names_to = "day", values_to = "recation_time")

sleep_wide |> 
   pivot_longer(cols = starts_with("day"), names_to = "day", values_to = "recation_time")
```
...
- More days of without leads to longer reaction time
